"""
Generates a clean, single-column, ATS-friendly resume PDF.
Deliberately simple layout (no columns/tables/images) so applicant
tracking systems can parse it correctly - fancy layouts often break ATS
text extraction.
"""
